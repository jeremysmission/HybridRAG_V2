...
| 4 | `docs/SPRINT_SYNC.md` | Retire from readiness use now | Still says Sprint 14/15 are done, records `25/25` and `10/10 rehearsal` language, and overstates current readiness. | `docs/MAY2_CANONICAL_DEMO_PACKET_2026-04-12.md` plus `docs/V2_DEMO_READINESS_GAP_ANALYSIS_2026-04-12.md` |
