...
6. Do not fake OSS-20B provenance for any CoPilot+/CoPilot+ development run.
7. Trust live repo probes and canonical docs over memory or stale shell output.
8. Treat `{USER_HOME}\HYBRIDRAG_LOCAL_ONLY\` as the canonical home for provider-specific hard-tail work, not as a temporary spill folder.
9. All hard-tail CoPilot+ Max / CoPilot+ style testing, raw results, helper scripts, prompts, and manifests stay in that outside-repo root unless a curated summary is intentionally promoted.
...
OVERNIGHT CoPilot+ DEVELOPMENT-ORACLE RESULTS:
...
5. This is strong enough to justify:
   - CoPilot+ on the same fixed 50-chunk pack
...
- If CoPilot+/CoPilot+ wins expose deterministic opportunities, push those back into Tier 1 / Tier 2.
- Save the future hosted strong-model lane for the truly irreducible hard tail.

MOST IMPORTANT NEXT MOVES:
1. Run CoPilot+ on the exact same fixed 50-chunk hardtail pack.
...
1. {USER_HOME}\HYBRIDRAG_LOCAL_ONLY\overnight_autonomous_runs\2026-04-14_master_01\00_meta\MORNING_REVIEW_INDEX_2026-04-14.md
2. {USER_HOME}\HYBRIDRAG_LOCAL_ONLY\overnight_autonomous_runs\2026-04-14_master_01\04_final_summary\MORNING_HANDBACK_claude_master_2026-04-14.md
3. {USER_HOME}\HYBRIDRAG_LOCAL_ONLY\overnight_autonomous_runs\2026-04-14_master_01\04_final_summary\OVERNIGHT_FINAL_EVIDENCE_claude_master_2026-04-14.md
4. {USER_HOME}\HYBRIDRAG_LOCAL_ONLY\provider_dev_bakeoffs\2026-04-14_claude_bakeoff_02_hardtail\CLAUDE_MAX_HARDTAIL_STRESS_TEST_EVIDENCE_2026-04-14.md
