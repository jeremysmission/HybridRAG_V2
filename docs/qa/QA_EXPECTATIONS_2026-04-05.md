...
When a GUI is present, add the full GUI QA protocol from `docs/qa/QA_GUI_HARNESS_2026-04-05.md`:
...
- Review `docs/architecture/Architecture_Pseudocode_2026-04-04.md` for next sprint's pseudocode
- Review `docs/planning/Sprint_Plan_2026-04-04.md` for next sprint's slices and exit criteria
