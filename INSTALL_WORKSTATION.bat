...
@REM Inputs: Repo folder with tools\setup_workstation_2026-04-12.bat present.
...
cd /d "%~dp0"
set "SCRIPT=%~dp0tools\setup_workstation_2026-04-12.bat"
set "SCRIPT_ARGS=%*"
...
if not exist "%SCRIPT%" (
  echo [FAIL] Installer launcher not found:
  echo        %SCRIPT%
