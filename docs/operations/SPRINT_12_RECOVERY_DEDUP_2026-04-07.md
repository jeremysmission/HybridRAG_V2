...
- operator runbook added in `CorpusForge/archive/2026-04-17/docs/qa/LEGACY_SKIP_STATE_AUDIT_2026-04-07.md`
...
- **DONE** (V2 side)
- operator runbook added in `CorpusForge/archive/2026-04-17/docs/qa/DOCUMENT_LEVEL_DEDUP_REVIEW_WORKFLOW_2026-04-07.md`
...
- operator handoff added in `CorpusForge/archive/2026-04-17/docs/handoffs/CANONICAL_LIST_REBUILD_HANDOFF_2026-04-07.md`
...
- **DONE** (V2 side)
- operator matrix added in `CorpusForge/archive/2026-04-17/docs/operations/FORMAT_COVERAGE_AND_DEFER_POLICY_2026-04-07.md`
