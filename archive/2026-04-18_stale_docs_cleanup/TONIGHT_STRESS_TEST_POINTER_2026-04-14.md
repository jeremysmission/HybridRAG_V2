...
- harder extraction
- more relationship recovery pressure
- harder procurement / CAP / logistics chunks
- a larger enrichment pilot in the same run

This prompt writes outside the repo on purpose.
