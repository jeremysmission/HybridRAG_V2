...
Supersedes: `WORKSTATION_STACK_INSTALL_2026-04-06.md`

## Bottom Line

Yes, the stack is ready for workstation install, and the current HybridRAG V2 operator truth now lives in the `2026-04-12` installer surfaces.
...
- active HybridRAG V2 dated wrapper: `tools/setup_workstation_2026-04-12.bat`
- legacy wrapper compatibility path: `tools/setup_workstation_2026-04-06.bat` -> `tools/setup_workstation_2026-04-12.bat`
...
These are the workstation bring-up patterns worth preserving:
...
- `INSTALL_WORKSTATION.bat` is the canonical launcher and forwards arguments to `tools/setup_workstation_2026-04-12.bat`
- `tools/setup_workstation_2026-04-12.bat` is the current dated wrapper and launches `tools/setup_workstation_2026-04-12.ps1`
- `tools/setup_workstation_2026-04-06.bat` remains only as a compatibility shim for older operator notes / shortcuts
