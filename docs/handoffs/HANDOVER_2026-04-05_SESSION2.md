...
**Sprint 5 QA checklist:** In docs/planning/SPRINT_PLAN_REVISED_2026-04-05.md under "Sprint 5 QA Checklist"
...
**Game plan:** docs/planning/SPRINT_6_GAMEPLAN_2026-04-05.md (12 slices, fully planned)
...
| File | What |
|------|------|
| C:\HybridRAG_V2\docs\planning\SPRINT_PLAN_REVISED_2026-04-05.md | Active sprint plan |
| C:\HybridRAG_V2\docs\planning\SPRINT_6_GAMEPLAN_2026-04-05.md | Next sprint plan |
| C:\HybridRAG_V2\docs\architecture\PIPELINE_STAGES_AND_THROUGHPUT_2026-04-05.md | How the 3 stages work |
| C:\HybridRAG_V2\docs\architecture\HOW_IT_WORKS_TECHNICAL_2026-04-05.md | Full architecture |
...
1. `docs/planning/SPRINT_PLAN_REVISED_2026-04-05.md` — master sprint plan, Sprint 5 status
2. `docs/planning/SPRINT_6_GAMEPLAN_2026-04-05.md` — Sprint 6 slices, research findings, exit criteria
3. `docs/architecture/PIPELINE_STAGES_AND_THROUGHPUT_2026-04-05.md` — how the 3 stages work, speeds, commands
4. `docs/architecture/HOW_IT_WORKS_TECHNICAL_2026-04-05.md` — full architecture block diagram
5. `docs/qa/QA_EXPECTATIONS_2026-04-05.md` — QA standards including agentic eval practices
